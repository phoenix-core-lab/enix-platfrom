    ...
    <>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {activeTab === "personal" ? (
            <div
              className={`grid justify-center md:${
                !isActiveUser ? "grid-cols-2" : "grid-cols-1"
              } gap-4 sm:gap-6 lg:gap-8 xs:gap-12`}
            >
              {!isActiveUser && (
                <div className="rounded-[8px] bg-background-prices p-6 border-2 border-borderColor-pricesSecond max-w-[500px]">
              ...
              <div
                className={`rounded-[8px] bg-background-prices p-6 border-2 border-borderColor-prices relative  max-w-[500px]`}
              >
            ...
            <div className="max-w-md mx-auto">
              {/* Team Tier */}
              <div className="rounded-[8px] bg-[#222222] p-8">
