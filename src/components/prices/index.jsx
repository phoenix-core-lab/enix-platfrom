  ...
  return (
    <>
      <ToastContainer
        ...
        pauseOnHover={false}
      />
      <div className={`min-h-screen bg-background-prices text-text pt-6 pb-12 px-4`}>
        <button
          onClick={() => router.push("/")}
        ...
        <div className='max-w-5xl mx-auto'>
          <h1 className='text-4xl font-bold text-center mb-8'>{isActiveUser ? t("Soldtitle") : t("Maintitle")}</h1>

          {activeTab === "personal" ? (
            <div
              className={`grid grid-cols-1 md:${
                !isActiveUser ? "grid-cols-2" : "grid-cols-1"
              } gap-4 sm:gap-6 lg:gap-8 xs:gap-12`} // Увеличение gap
            >
              {/* Free Tier */}
              {!isActiveUser && (
                <div className='rounded-lg bg-background-prices p-6 border-2 border-borderColor-pricesSecond max-w-[500px]'>
                  <h2 className='text-xl font-bold mb-4'>{t("Free.Maintitle")}</h2>
                  <div className='flex items-baseline mb-5'>
                    <span className='text-4xl font-extrabold'>20</span>
                    <span className='ml-1 text-gray-400'>{t("Free.price")}</span>
                  </div>
                  <div className='flex items-center gap-2 text-red-600 font-medium  rounded-[10px] mb-5'>
              ...
              >
                ...
                <div className='flex items-baseline mb-8'>
                  ...
                  <span className='ml-1 text-gray-400'>{t("Premium.price")}</span>
                </div>
                ...
                >
                  {!isActiveUser ? t("Premium.buttonText") : t("Free.buttonText")}
                </button>
                <ul className='space-y-3 mb-8'>
                  <li className='flex items-start'>
                ...
                <div className='text-sm text-gray-400'>{t("Premium.bottomText")}</div>
              </div>
            </div>
          ) : (
            <div className='max-w-md mx-auto'>
              ...
              <div className='rounded-lg bg-[#222222] p-8'>
                ...
                <p className='mb-8'>
                  Улучшите работу своей команды с помощью безопасного рабочего пространства для совместной работы
                </p>
                <button className='w-full py-3 px-4 rounded-md bg-[#00A67E] text-white mb-8'>Получить Team</button>
                <ul className='space-y-4 mb-8'>
                  <li className='flex items-start'>
                    <Check className='min-w-[20px] h-5 w-5 text-[#00A67E] mr-2 mt-0.5' />
                    <span>
                      Более высокие ограничения на количество сообщений для GPT-4, GPT-4o и такие инструменты, как
                      DALL·E, просмотр веб-страниц, анализ данных и многое другое
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <Check className='min-w-[20px] h-5 w-5 text-[#00A67E] mr-2 mt-0.5' />
                  ...
                  <li className='flex items-start'>
                    <Check className='min-w-[20px] h-5 w-5 text-[#00A67E] mr-2 mt-0.5' />
                    <span>Консоль администратора для управления рабочей областью</span>
                  </li>
                  <li className='flex items-start'>
                    <Check className='min-w-[20px] h-5 w-5 text-[#00A67E] mr-2 mt-0.5' />
                    <span>
                      Данные команды исключены из обучения по умолчанию.{" "}
                      <Link className='text-[#00A67E] hover:underline'>Узнать больше</Link>
                    </span>
                  </li>
                </ul>
                <div className='text-sm text-gray-400'>Для 2+ пользователей, ежегодное выставление счетов</div>
              </div>
            </div>
          )}
